...
class ActorCritic:
	...
	def create_actor_model(self):
		...
		h1 = Dense(24, activation='softmax')(state_input)
		h2 = Dense(48, activation='softmax')(h1)
		h3 = Dense(24, activation='softmax')(h2)
		action_size = 5
		output = Dense(action_size, activation='softmax')(h3)
	...
	def act(self, cur_state):
		...
		act_values = self.actor_model.predict(cur_state)
		return act_values
